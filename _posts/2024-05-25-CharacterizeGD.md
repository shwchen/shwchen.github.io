...
## 1.3 Desired Properties for Homophily Measures
...
### 1.3.2 Minimal Agreement (Min)

The opposite of Maximal Agreement.

### 1.3.3 Asymptotic Constant Baseline (ACB)
...
### 1.3.4 Empty Class Tolerance (ECT)
...
| Datasets | Classes | Edge | Adjusted | LI |
| :--- | :---: | :---: | :---: | :---: |
| lastfm-asia | 18 | 0.87 | 0.86 | 0.74 |
...
Results of the *questions* indicate that Edge Homophily measure might indicate high level of homophily for heterophilous graphs. Results of *lastfm-asia* and *cora* indicate that for highly homophilous graphs, their LI are also high, whereas the results of *ogbn-arxiv* and *twitter-hate* indicate that for mediumly homophilous graphs can have very different LI. The results of *roman-empire* indicate that LI successfully capture heterophlous patterns.

To show that LI better align with GNN performance than homophily. the author conduct experiments on datasets semi-genrated by stochastic block model and measure the pearson correclation of performances vs Adjust Homophily/Label Informativeness.
